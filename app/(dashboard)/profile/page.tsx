      ...
      <div className="bg-white px-4 pt-6 pb-4">
        <div className="max-w-lg mx-auto">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 bg-[#e3c9dc]/30 rounded-2xl flex items-center justify-center text-[#824c71] shrink-0">
          ...
          {userData.role === 'ADMIN' && (
            <Link
              href="/admin/support"
              className="mt-4 flex items-center gap-2 bg-[#824c71]/10 text-[#824c71] px-4 py-2.5 rounded-xl text-sm font-medium hover:bg-[#824c71]/20 transition-colors"
            >
          ...
          <div className="bg-white rounded-2xl p-4 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-zinc-200 rounded-xl px-3.5 py-2.5 text-sm focus:border-[#d3aec8] focus:ring-2 focus:ring-[#e3c9dc]/40 outline-none transition-all"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  dir="ltr"
                  className="w-full border border-zinc-200 rounded-xl px-3.5 py-2.5 pl-10 text-sm text-left focus:border-[#d3aec8] focus:ring-2 focus:ring-[#e3c9dc]/40 outline-none transition-all"
                />
              </div>
            </div>
            <button
          ...
          <div className="bg-white rounded-2xl p-4">
            {salonData ? (
              ...
              <div className="text-center py-8">
                <div className="w-16 h-16 bg-[#e3c9dc]/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
