      ...
      try {
        ...
        if (res.ok) {
          ...
          if (salon) {
            ...
            if (salon.imageUrl) {
              setExistingCover(salon.imageUrl);
            }
    ...
    try {
      ...
      if (coverImage) {
        ...
        if (!coverRes.ok) {
          ...
          throw new Error(errorData.error || 'خطا در آپلود عکس کاور');
        }
      ...
      if (portfolios.length > 0) {
        ...
        if (!portfolioRes.ok) {
          ...
          throw new Error(errorData.error || 'خطا در آپلود نمونه‌کارها');
        }
        ...
        {step === 1 && (
          <div className="space-y-8 animate-fade-in">
            ...
            <section className="space-y-6">
              ...
              {/* بخش انتخاب و نمایش نقشه - کاملا مشابه صفحه ثبت */}
