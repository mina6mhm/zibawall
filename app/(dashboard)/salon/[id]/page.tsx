...
{salon.socials.bale && (
  ...
  return (
    <>
      ...
      {salon.phones && salon.phones.length > 0 && (
  <div className="fixed bottom-[80px] left-0 right-0 px-3 z-[60] lg:hidden">
    <a href={`tel:${salon.phones[0]}`} className="flex w-full bg-zinc-900 text-white font-medium py-3.5 rounded-xl text-sm items-center justify-center gap-2 active:bg-black shadow-lg">
