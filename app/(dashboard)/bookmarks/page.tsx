...
export default function BookmarksPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto pt-8 pb-32 px-4 md:pt-10 md:px-0">
      <div className="mb-7">
        <h1 className="text-xl md:text-2xl font-bold text-zinc-900">نشان‌شده‌ها</h1>
        <p className="text-zinc-500 text-xs md:text-sm mt-0.5">سالن‌هایی که ذخیره کرده‌اید</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {isLoading ? (
          // placeholder برای زمان بارگذاری
          [1, 2, 3, 4].map((n) => (
              ...
              >
                ...
                <div dir="rtl" className="flex-1 min-w-0 p-3 flex flex-col">
                  ...
                  <div className="flex items-start justify-between gap-2">
                    ...
                    >
                      <BookmarkIcon isActive={true} className="w-5 h-5" />
                    </button>
                  </div>
          ...
          // پیام برای زمانی که لیست بوک‌مارک خالی است
