...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-white text-zinc-900 dir-rtl font-sans selection:bg-zinc-200">
            ...
            return (
              <Link 
                ...
                className={`flex items-center gap-3 px-3 py-3 rounded-lg transition-colors duration-200 text-[13px] ${
                  isActive ? 'bg-zinc-50 text-black font-semibold' : 'text-zinc-500 hover:text-black'
                }`}
              >
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-zinc-100 pb-safe">
